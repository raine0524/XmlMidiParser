...
//Tremolo
@property (nonatomic,assign) int tremolo_stop_note_count;
@property (nonatomic,assign) BOOL tremolo_beem_mode;

//arpeggiate
@property (nonatomic,assign) int arpeggiate_over_voice;
@property (nonatomic,assign) int arpeggiate_over_staff;
...
@property (nonatomic,assign) float display_note_x;
@end
...
@property (nonatomic,strong) CommonBlock *pos;
@property (nonatomic, assign) signed short offset_y;
@property (nonatomic, assign) BOOL ending_play;
-(int) getJumpCount;
...
@property (nonatomic, assign) int page_height,page_width,xml_page_height;   //both
...
//to parse xml
@property (nonatomic, strong) OveWedge *opened_wedge1, *opened_wedge2;
+ (OveData*) ove_data;
